...
class addStub(object):
    ...
    def __init__(self, channel):
        ...
        self.add = channel.unary_unary(
                ...
                response_deserializer=lab6__pb2.addMsg.FromString,
                )
...
def add_addServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'add': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=lab6__pb2.addMsg.SerializeToString,
            ),
    }
...
class image(object):
    ...
    def image(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/image/image',
            lab6__pb2.imageMsg.SerializeToString,
            lab6__pb2.addMsg.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
